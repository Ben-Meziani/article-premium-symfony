 ...
 */
final class Version20211214221723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD first_name VARCHAR(30) NOT NULL, ADD lastname VARCHAR(30) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP first_name, DROP lastname');
    }
}
